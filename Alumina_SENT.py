...
# This new phase-field model is used to solve the 'Single edge notch tension test' in Alumina for different lengths of the notch.
# 
#
...
domain2 = CompiledSubDomain("x[1]<2.5*eps && x[0]<a+eps*4 && x[0]>a-eps*4", a=ac, eps=eps, h=h)
ir=0
while ir<3:
	d_markers = MeshFunction("bool", mesh, 2, False)
